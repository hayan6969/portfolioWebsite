...
function Nav() {
    ...
    const Menus = [
        ...
        { name: "Skills", icon: "code-slash-outline", dis: "translate-x-16",href:'#tech' },
        { name: "Projects", icon: "folder-open-outline", dis: "translate-x-32",href:'#project' },
        { name: "Github", icon: "logo-github", dis: "translate-x-48",href:'https://github.com/hayan6969',target:'_blank' },
        { name: "Linkedin", icon: "logo-linkedin", dis: "translate-x-64",href:'https://www.linkedin.com/in/hayan-khan-9b154826a/',target:'_blank' },
      ];
